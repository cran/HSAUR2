...
###################################################
### code chunk number 3: ANOVA-weightgain-mean-var
###################################################
...
###################################################
### code chunk number 4: ANOVA-weightgain-plot
###################################################
plot.design(weightgain)


###################################################
### code chunk number 5: ANOVA-weightgain-aov
###################################################
wg_aov <- aov(weightgain ~ source * type, data = weightgain)


###################################################
### code chunk number 6: ANOVA-weightgain-aov-summary
###################################################
summary(wg_aov)


###################################################
### code chunk number 7: ANOVA-weightgain-iplot (eval = FALSE)
###################################################
...
###################################################
### code chunk number 8: ANOVA-weightgain-iplot-nice
###################################################
...
###################################################
### code chunk number 9: ANOVA-weightgain-coef
###################################################
coef(wg_aov)


###################################################
### code chunk number 10: ANOVA-weightgain-contrasts
###################################################
options("contrasts")


###################################################
### code chunk number 11: ANOVA-weightgain-coef-sum
###################################################
...
###################################################
### code chunk number 12: ANOVA-foster
###################################################
data("foster", package = "HSAUR2")


###################################################
### code chunk number 13: ANOVA-foster-plot
###################################################
plot.design(foster)


###################################################
### code chunk number 14: ANOVA-foster-aov-one (eval = FALSE)
###################################################
## summary(aov(weight ~ litgen * motgen, data = foster))


###################################################
### code chunk number 15: ANOVA-foster-aov-one
###################################################
summary(aov(weight ~ litgen * motgen, data = foster))


###################################################
### code chunk number 16: ANOVA-foster-aov-two (eval = FALSE)
###################################################
## summary(aov(weight ~ motgen * litgen, data = foster))


###################################################
### code chunk number 17: ANOVA-foster-aov-two
###################################################
summary(aov(weight ~ motgen * litgen, data = foster))


###################################################
### code chunk number 18: ANOVA-weightgain-again (eval = FALSE)
###################################################
## summary(aov(weightgain ~ type * source, data = weightgain))


###################################################
### code chunk number 19: ANOVA-foster-aov
###################################################
foster_aov <- aov(weight ~ litgen * motgen, data = foster)


###################################################
### code chunk number 20: ANOVA-foster-tukeyHSD
###################################################
...
###################################################
### code chunk number 21: ANOVA-foster-tukeyHSDplot
###################################################
plot(foster_hsd)


###################################################
### code chunk number 22: ANOVA-water-manova
###################################################
...
###################################################
### code chunk number 23: ANOVA-water-means
###################################################
...
###################################################
### code chunk number 24: ANOVA-skulls-data
###################################################
...
###################################################
### code chunk number 25: ANOVA-skulls-fig
###################################################
pairs(means[,-1],
    panel = function(x, y) {
...
###################################################
### code chunk number 26: ANOVA-skulls-manova
###################################################
...
###################################################
### code chunk number 27: ANOVA-skulls-manova2
###################################################
summary.aov(skulls_manova)


###################################################
### code chunk number 28: ANOVA-skulls-manova3
###################################################
